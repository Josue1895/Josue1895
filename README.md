...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:var(--bg);color:var(--text);line-height:1.6}
    ...
    .badges{display:flex;flex-wrap:wrap;gap:.4rem}.badge{padding:.35rem .65rem;border-radius:999px;border:1px dashed var(--bd);color:var(--muted)}
    /* SECTIONS */
    ...
    .tags{display:flex;flex-wrap:wrap;gap:.4rem}.tag{font-size:.8rem;padding:.3rem .55rem;border:1px solid var(--bd);border-radius:999px;color:var(--muted)}
